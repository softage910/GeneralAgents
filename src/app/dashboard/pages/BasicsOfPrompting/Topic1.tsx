...
<h2 className="h2"><strong>Contextual vs. Non-Contextual actions</strong></h2>
            ...
            <ol className="ol">
                ...
                <ul className="ul">
                    ...
                    <a href="https://drive.google.com/file/d/1Z_KWhlw8RtvK80lgSWcqXeXY8BbupE2V/view?usp=drive_link" target="_blank">                                <button className='Watch-Button'>
                                    Link to the Video
                                </button>
                            </a>
                </ul>
                ...
                <ul className="ul">
                    ...
                    <a href="https://drive.google.com/file/d/1qFNL2K6njqePJ_ZsoGDEiMSmgk7b9Mn3/view?usp=drive_link" target="_blank">                                <button className='Watch-Button'>
                                    Link to the Video
                                </button>
                            </a>
                </ul>
