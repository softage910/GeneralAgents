...
import Topic1 from "./ToolCoverageFunctionMapper/Topic1";



export default function ToolCoverage() {
  ...
  return (
    <div className="Day1-Main">
      <div className="Header">
        <h1 className="h1">Extensive Tool Coverage and Function Mapper</h1>
      </div>
